...
- `public/media/roam-search.*` and `public/media/roam-calculator-mobile.*` remain committed as optional alternates, but are not rendered so the current presentation stays focused.
